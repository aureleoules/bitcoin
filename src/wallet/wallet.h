...
std::unique_ptr<WalletDatabase> MakeWalletDatabase(WalletContext& context, const std::string& name, const DatabaseOptions& options, DatabaseStatus& status, bilingual_str& error);
