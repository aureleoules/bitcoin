...
static AddressTableEntry::Type translateTransactionType(const QString &strPurpose, bool isMine)
{
    ...
    if (strPurpose == wallet::AddressBookPurposes::SEND)
        addressType = AddressTableEntry::Sending;
    else if (strPurpose == wallet::AddressBookPurposes::RECEIVE)
        addressType = AddressTableEntry::Receiving;
    else if (strPurpose == wallet::AddressBookPurposes::UNKNOWN || strPurpose == "") // if purpose not set, guess
